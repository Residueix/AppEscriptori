 ...
 * @version 07/04/2023
 */
public class PantallaModificarPuntRecollida extends javax.swing.JFrame {
    ...
    */
     ...
     * @param idPunt: id punt de recollida
     */
    public PantallaModificarPuntRecollida(Usuari usuari, int idPunt) {
    ...
    private void initComponents() {
        ...
        labelObligatori1 = new javax.swing.JLabel();
        labelObligatori2 = new javax.swing.JLabel();
        labelObligatori3 = new javax.swing.JLabel();
        labelObligatori5 = new javax.swing.JLabel();
        labelObligatori6 = new javax.swing.JLabel();
        ...
        labelTitol.setText("Modificar Punt de recollida");
        ...
        panelContingut.add(labelPathImatge, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 530, 470, 30));
        ...
        panelContingut.add(buttonSeleccionarImatge, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 530, 150, 30));
        ...
        buttonModificacio.setText("Modificar punt");
        buttonModificacio.setToolTipText("Modificar punt de recollida");
        ...
        panelContingut.add(comboBoxPoblacions, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 430, 360, -1));
        ...
        labelObligatori1.setFont(new java.awt.Font("Sansation", 1, 14)); // NOI18N
        labelObligatori1.setForeground(new java.awt.Color(255, 0, 0));
        labelObligatori1.setText("*");
        panelContingut.add(labelObligatori1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 540, 20, -1));

        labelObligatori2.setFont(new java.awt.Font("Sansation", 1, 14)); // NOI18N
        labelObligatori2.setForeground(new java.awt.Color(255, 0, 0));
        labelObligatori2.setText("*");
        panelContingut.add(labelObligatori2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 170, 20, -1));

        labelObligatori3.setFont(new java.awt.Font("Sansation", 1, 14)); // NOI18N
        labelObligatori3.setForeground(new java.awt.Color(255, 0, 0));
        labelObligatori3.setText("*");
        panelContingut.add(labelObligatori3, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 170, 20, -1));

        labelObligatori5.setFont(new java.awt.Font("Sansation", 1, 14)); // NOI18N
        labelObligatori5.setForeground(new java.awt.Color(255, 0, 0));
        labelObligatori5.setText("*  Camps obligatoris");
        panelContingut.add(labelObligatori5, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 700, 160, -1));

        labelObligatori6.setFont(new java.awt.Font("Sansation", 1, 14)); // NOI18N
        labelObligatori6.setForeground(new java.awt.Color(255, 0, 0));
        labelObligatori6.setText("*");
        panelContingut.add(labelObligatori6, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 220, 20, -1));
    ...
    private void carregaFormulari(){
        ...
        if(jsonPunt.getString("codi_error").equals("0")){
            ...
            // Combo població
            comboBoxPoblacions.setSelectedItem(jsonPunt.getString("nom_poblacio"));
    ...
    private void resetFormulari(){
        buttonModificacio.setVisible(false);
    ...
    private void buttonModificacioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonModificacioActionPerformed
        ...
        // Comprovem latitud
        if(!Utils.validarDecimal(textFieldLatitud.getText())){
            if(!textFieldLatitud.getText().equals("")){
                enviament = false;
                missatge += "La latitud no és vàlida.";
            }
        }
        
        // Comprovem longitud
        if(!Utils.validarDecimal(textFieldLongitud.getText())){
            if(!textFieldLongitud.getText().equals("")){
                enviament = false;
                missatge += "La latitud no és vàlida.";
            }
        }
        ...
        // Comprovem el carrer
        if(!Utils.validarText(textFieldCarrer.getText(),10,255)){
             if(!textFieldCarrer.getText().equals("")){
                enviament = false;
                 missatge += "El nom ha de tenir com a mínim 10 i com a màxim 255 caràcters.";
            }
        }
        
        // Comprovem el codi postal
        if(!Utils.validarCP(textFieldCP.getText())){
             if(!textFieldCP.getText().equals("")){
                enviament = false;
                missatge += "El codi postal no és vàlid. ha de ser 5 caràcters numèrics.";
            }
        }
        ...
        // Comprovem el horari
        if(!Utils.validarText(textFieldHorari.getText(),5,255)){
             if(!textFieldHorari.getText().equals("")){
                enviament = false;
                missatge += "L'horari ha de tenir com a mínm 5 i com a màxim 355 caràcters.";
             }
        }
                
        // Comprovem la imatge (tenint en compte si s'ha canviat o no.
        ...
        if(enviament){
            JSONObject jsonRetorn = Api.modificacioPunt(usuari, idPuntRecollida, textFieldNom.getText(), textAreaDescripcio.getText(), textFieldLatitud.getText(), textFieldLongitud.getText(), textFieldCarrer.getText(), textFieldCP.getText(), id_poblacio, textFieldHorari.getText(),imatge, Utils.validarCheckbox(checkBoxActiu.isSelected()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaModificarPuntRecollida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaModificarPuntRecollida(usuari,idPuntRecollida).setVisible(true);
            }
        });
    ...
    */
    ...
    /**
    * Label per indicar que és obligatori
    */
    private javax.swing.JLabel labelObligatori1;
    /**
    * Label per indicar que és obligatori
    */
    private javax.swing.JLabel labelObligatori2;
    /**
    * Label per indicar que és obligatori
    */
    private javax.swing.JLabel labelObligatori3;
    /**
    * Label per indicar que és obligatori
    */
    private javax.swing.JLabel labelObligatori5;
    /**
    * Label per indicar que és obligatori
    */
    private javax.swing.JLabel labelObligatori6;
    /**
