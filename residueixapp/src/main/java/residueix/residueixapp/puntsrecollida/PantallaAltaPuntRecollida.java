 ...
 * @version 07/04/2023
 */
public class PantallaAltaPuntRecollida extends javax.swing.JFrame {
    ...
    */
     ...
     */
    public PantallaAltaPuntRecollida(Usuari usuari) {
    ...
    private void initComponents() {
        ...
        labelTitol.setText("Alta Punt de recollida");
        ...
        buttonAlta.setToolTipText("Donar d'alta punt de recollida");
    ...
    private void buttonAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAltaActionPerformed
        ...
        if(enviament){
            JSONObject jsonRetorn = Api.altaPunt(usuari, textFieldNom.getText(), textAreaDescripcio.getText(), textFieldLatitud.getText(), textFieldLongitud.getText(), textFieldCarrer.getText(), textFieldCP.getText(), id_poblacio, textFieldHorari.getText(),imatge, Utils.validarCheckbox(checkBoxActiu.isSelected()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaAltaPuntRecollida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaAltaPuntRecollida(usuari).setVisible(true);
            }
        });
