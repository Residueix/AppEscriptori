    ...
    */
    ...
    private void carregaFormulari(){
        ...
        if(jsonEsdeveniment.getString("codi_error").equals("0")){
            textFieldNom.setText(jsonEsdeveniment.getString("nom"));
            // Actiu
            if(jsonEsdeveniment.getString("actiu").equals("1")){
                checkBoxActiu.setSelected(true);
            }else{
                checkBoxActiu.setSelected(false);   
            }
            textAreaDescripcio.setText(jsonEsdeveniment.getString("descripcio"));
            textFieldValor.setText(jsonEsdeveniment.getString("valor"));
            textFieldAforament.setText(jsonEsdeveniment.getString("aforament"));
            
            // Camps data
            String[] data = Utils.obtenirData(jsonEsdeveniment.getString("data"));
            
            if(data != null){
                textFieldHora.setText(data[3]);
            ...
            ImageIcon imatgeEsd = Utils.carregaImatge(4,jsonEsdeveniment.getString("imatge"));
            labelImatgeSeleccionada.setIcon(imatgeEsd);
        }else{
        ...
        labelId.setText(jsonEsdeveniment.getString("id"));
