...
public class PantallaAltaResidu extends javax.swing.JFrame {
    ...
    */
    ...
    private void initComponents() {
        ...
        panelContingut.add(scrollPaneDescripcio, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 220, 530, 230));
        ...
        panelContingut.add(labelImatgeSeleccionada, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 540, 120, 120));
    ...
    private void buttonAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAltaActionPerformed
        ...
        if(enviament){
            try {
                Api.altaResidu(usuari, textFieldNom.getText(), textAreaDescripcio.getText(), imatge, Utils.validarCheckbox(checkBoxActiu.isSelected()));
